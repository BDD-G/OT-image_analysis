...
Date: 2023-07-12 23:25:09
LastEditors: A1yssa8 a1yssa.yu@outlook.com
LastEditTime: 2023-07-16 16:48:28
FilePath: /OT_image_analysis/robot-control/OT2_functions.py
...
commands_url = ""  # 添加全局变量 commands_url
pipette_id = ""  # 添加全局变量 pipette_id

def create_run():
    global commands_url
     # 将 commands_url 声明为全局变量
...
def load_equipment(equipment_type, equipment_name, *location):
    ...
    if equipment_type == 1:
        ...
        labware_id = r_dict["data"]["result"]["labwareId"] #labware id
        ...
        pipette_id = r_dict["data"]["result"]["pipetteId"] #pipette id
        print(f"Pipette ID:\n{pipette_id}\n")
        id_value = pipette_id
    ...
    command_dict = {
        "data": {
            ...
            "params": {
                ...
                "wellName": wellname_value,
                "wellLocation": {
                    "origin": "top", "offset": offset_value #调整位置
                },
                "pipetteId": pipette_id
            },
            "intent": "setup"
